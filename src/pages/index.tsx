  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox again - Bridging the gap between freelancers and companies. Your one-stop marketplace for jobs and talents."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox again - Bridging the gap between freelancers and companies. Your one-stop marketplace for jobs and talents.`}
            </Text>
            <Box
